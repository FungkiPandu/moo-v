...
class FavoriteTVsWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun updateAppWidget(
            ...
            intent.putExtra(MOVIE_TYPE, Movie.MovieType.TV_SHOW.name)
            ...
            views.setTextViewText(R.id.banner_text, context.getText(R.string.favorite_tvs))

            val toastIntent = Intent(context, FavoriteTVsWidget::class.java)
